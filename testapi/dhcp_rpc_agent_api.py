...
class DhcpAgentNotifyAPI(object):
    ...
    def _schedule_network(self, context, network, existing_agents):
        ...
        if new_agents:
            ...
            LOG.warn(('Unable to schedule network %s: no agents available; '
    ...
    def _get_enabled_agents(self, context, network, agents, method, payload):
        ...
        if len_active_agents < len_enabled_agents:
            LOG.warn(("Only %(active)d of %(total)d DHCP agents associated "
	...
	'''
	self._cast_message(
                    context, method, payload, "192.168.49.22", "dhcp_agent")
